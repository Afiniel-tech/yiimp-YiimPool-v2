...
<!-- Change your demo wallet here -->
			<input id="text-wallet" type="text" size="35" placeholder=" bc1qpnxtg3dvtglrvfllfk3gslt6h5zffkf069nh8r" style="border-style:solid; border-width: thin; padding: 3px; font-family: monospace; border-radius: 5px;">
		</td>
